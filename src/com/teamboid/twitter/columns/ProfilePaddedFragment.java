...
/**
 * A base column extended by the {@link PaddedProfileTimelineFragment} and
 * {@link ProfileAboutFragment}, uses padding in its layout to compensate for
...
public abstract class ProfilePaddedFragment extends BaseListFragment
{
	...
	{
		View mProgressContainer = getActivity().findViewById(
