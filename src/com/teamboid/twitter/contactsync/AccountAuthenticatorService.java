...
public class AccountAuthenticatorService extends Service {
	...
	private static class AccountAuthenticatorImpl extends AbstractAccountAuthenticator{
		...
		@Override
		public Bundle addAccount(AccountAuthenticatorResponse response, String arg1,
				String arg2, String[] arg3, Bundle arg4)
				throws NetworkErrorException {
			Bundle reply = new Bundle();
			
			Intent i = new Intent( mContext, AccountManager.class );
			i.putExtra(android.accounts.AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
