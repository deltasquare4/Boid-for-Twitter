...
public class Api16 {
     ...
     */
    public static void displayReplyNotification(final int accId, final Context context, final Bitmap profileImg,
                                                final Status s, final Builder nb, final NotificationManager nm) {
