...
public class SendTweetTask
{
	...
	static
	{
		...
		MEDIA_API_KEYS.put("twitpic",
				"458BDELY0594bdbc2776ba73ac25e8fc96a03c27");
	...
	public SendTweetTask.Result sendTweet(Context context)
	{
		...
		if (this.hasMedia())
		{
			try
			{
				...
				update = MediaUtilities.getMediaServices(false, context)
						.get(prefValue).attachMedia(input, update, this);
			}
			catch (Exception e)
			{
				e.printStackTrace();
