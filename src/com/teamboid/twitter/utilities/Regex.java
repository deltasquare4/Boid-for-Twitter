...
public class Regex {
	...
	public static final Pattern VALID_SEARCH= Pattern.compile("(^|[^&" + HASHTAG_ALPHA_NUMERIC_CHARS + "])(\\$|\uFF03)(" + HASHTAG_ALPHA_NUMERIC + "*" + HASHTAG_ALPHA + HASHTAG_ALPHA_NUMERIC + "*)", Pattern.CASE_INSENSITIVE);
